/**
 * DORAEMON MOVIES WITH IMAGES FROM LOCAL FOLDER
 * Complete list of Doraemon movies with images from src/movie_Image folder
 */
...
export interface MovieWithImages {
  ...
  // Image filenames from movie_Image folder
  images: {
    poster: string;           // Movie poster filename
    backdrop: string;         // Movie backdrop filename
    heroImage?: string;       // Large hero image filename
  };
...
export const moviesWithImages: MovieWithImages[] = [
  {
    ...
    images: { poster: "Nobita's Dinosaur (1980).jpg", backdrop: "Nobita's Dinosaur (1980).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Haunts of Evil (1982).jpg", backdrop: "Nobita and the Haunts of Evil (1982).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Castle of the Undersea Devil (1983).jpg", backdrop: "Nobita and the Castle of the Undersea Devil (1983).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's Great Adventure into the Underworld (1984).webp", backdrop: "Nobita's Great Adventure into the Underworld (1984).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's Little Star Wars (1985).jpg", backdrop: "Nobita's Little Star Wars (1985).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Steel Troops (1986).webp", backdrop: "Nobita and the Steel Troops (1986).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Knights on Dinosaurs (1987).webp", backdrop: "Nobita and the Knights on Dinosaurs (1987).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's Parallel \"Journey to the West\" (1988).webp", backdrop: "Nobita's Parallel \"Journey to the West\" (1988).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Birth of Japan (1989).webp", backdrop: "Nobita and the Birth of Japan (1989).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Animal Planet (1990).webp", backdrop: "Nobita and the Animal Planet (1990).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's Dorabian Nights (1991).jpg", backdrop: "Nobita's Dorabian Nights (1991).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Kingdom of Clouds (1992).webp", backdrop: "Nobita and the Kingdom of Clouds (1992).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Three Magical Swordsmen (1994).jpg", backdrop: "Nobita and the Three Magical Swordsmen (1994).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Galactic Express (1996).jpg", backdrop: "Nobita and the Galactic Express (1996).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the Spiral City (1997).webp", backdrop: "Nobita and the Spiral City (1997).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita in the Wan-Nyan Space-Time Odyssey (2004).jpg", backdrop: "Nobita in the Wan-Nyan Space-Time Odyssey (2004).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's Dinosaur 2006 (2006).webp", backdrop: "Nobita's Dinosaur 2006 (2006).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita and the New Steel Troops (2011).jpg", backdrop: "Nobita and the New Steel Troops (2011).jpg" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's Chronicle of the Moon Exploration (2019).webp", backdrop: "Nobita's Chronicle of the Moon Exploration (2019).webp" },
  ...
  },
  {
    ...
    images: { poster: "Nobita's New Dinosaur (2020).webp", backdrop: "Nobita's New Dinosaur (2020).webp" },
  ...
  },
  {
    ...
    images: { poster: "Stand by Me Doraemon (2014).webp", backdrop: "Stand by Me Doraemon (2014).webp" },
  ...
  },
  {
    ...
    images: { poster: "Stand by Me Doraemon 2 (2020).jpg", backdrop: "Stand by Me Doraemon 2 (2020).jpg" },
